...
public class PayOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            RestaurantApprovalRequestAvroModel restaurantApprovalRequestAvroModel = orderMessagingDataMapper.orderPaidEventToRestaurantApprovalRequestAvroMode(domainEvent);
            ...
            log.info("Published RestaurantApprovalRequestAvroModel for order id: {}", orderId);
        } catch (Exception e) {
            log.error("Error while publishing RestaurantApprovalRequestAvroModel for order id: {}, error: {}", orderId, e.getMessage());
        }
