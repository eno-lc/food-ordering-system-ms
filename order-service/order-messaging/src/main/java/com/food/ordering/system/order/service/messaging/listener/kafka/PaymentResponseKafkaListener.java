...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public void receive(@Payload List<PaymentResponseAvroModel> messages,
        ...
        log.info("{} number of payment responses received with keys: {}, partitions: {}, offsets: {}", messages.size(), keys, partitions, offsets);
        messages.forEach(paymentResponseAvroModel -> {
            ...
            } else if(PaymentStatus.FAILED == paymentResponseAvroModel.getPaymentStatus() || PaymentStatus.CANCELLED == paymentResponseAvroModel.getPaymentStatus()){
                log.info("Processing failed payment for order id: {}", paymentResponseAvroModel.getOrderId());
